...
import {AppHeader, CustomIcon, CustomText} from '../../components';
...
const getMovieDetails = async (movieid: string) => {
  try {
    let response = await movieApi.getMovieDetail(movieid);
...
const getMovieCastDetails = async (movieid: string): Promise<any> => {
  try {
    let response = await movieApi.getMovieCastDetail(movieid);
